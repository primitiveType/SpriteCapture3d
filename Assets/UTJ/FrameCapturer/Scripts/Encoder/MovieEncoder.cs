...
namespace UTJ.FrameCapturer
{
    ...
    {
        public MovieEncoder.Type format;// = MovieEncoder.Type.SpriteSheet;
        ...
        public fcAPI.fcSpriteSheetConfig spritesheetEncoderSettings = fcAPI.fcSpriteSheetConfig.default_value;
        ...
        public bool supportVideo
        {
            get
            {
                return
                    ...
                    format == MovieEncoder.Type.SpriteSheet ||
        ...
        public bool captureVideo
        {
            get
            {
                switch (format)
                {
                    ...
                    case MovieEncoder.Type.SpriteSheet: return true;
                ...
                exrEncoderSettings.width =
                    gifEncoderSettings.width =
                        webmEncoderSettings.videoWidth =
                            mp4EncoderSettings.videoWidth =
                                spritesheetEncoderSettings.pngConfig.width = w;

            pngEncoderSettings.height =
                exrEncoderSettings.height =
                    gifEncoderSettings.height =
                        webmEncoderSettings.videoHeight =
                            mp4EncoderSettings.videoHeight =
                                spritesheetEncoderSettings.pngConfig.height = h;

            pngEncoderSettings.channels =
                exrEncoderSettings.channels = 
                    spritesheetEncoderSettings.pngConfig.channels = ch;
    ...
    public abstract class MovieEncoder : EncoderBase
    {
        ...
        public static MovieEncoder Create(Type t)
        {
            switch (t)
            {
                ...
                case Type.SpriteSheet: return new SpriteSheetEncoder();
            }
        ...
        public static MovieEncoder Create(MovieEncoderConfigs c, string path)
        {
            ...
            {
                case Type.Png:
                    ret.Initialize(c.pngEncoderSettings, path);
                    break;
                case Type.Exr:
                    ret.Initialize(c.exrEncoderSettings, path);
                    break;
                case Type.Gif:
                    ret.Initialize(c.gifEncoderSettings, path);
                    break;
                case Type.WebM:
                    ret.Initialize(c.webmEncoderSettings, path);
                    break;
                case Type.MP4:
                    ret.Initialize(c.mp4EncoderSettings, path);
                    break;
                case Type.SpriteSheet:
                    ret.Initialize(c.spritesheetEncoderSettings, path);
                    break;
            }
